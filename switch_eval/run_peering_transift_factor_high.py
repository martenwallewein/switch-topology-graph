...
def run_workflow():
    ...
    graph_file = "final_graph_link_types_high.json"
    traffic_file = "avg_by_destination.csv"

    # Output directories for the generated files
    scenario_output_dir = "peering_transit_factor_high/scenarios"
    results_output_dir = "peering_transit_factor_high/results"
