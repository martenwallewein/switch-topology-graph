...
def solve_cost_lp(problem_data, optimization_goal):
    ...
    for e_egress in E:
        ...
        # If any traffic flows through e_egress, y[e_egress] is forced to be 1.
        # The egress capacity serves as a suitable "M". If capacity is undefined, use a large number.
